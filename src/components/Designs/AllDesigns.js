...
function AllDesigns() {
  ...
  return (
    <div>
      <div><h3 className="mt-lg-4" style={{ color: '#262B40' }}>Designs Cases</h3>
        <p style={{ color: '#4a5073' }}>All the Designs related cases are in the below table and you can click on each case to view its details.</p></div>
