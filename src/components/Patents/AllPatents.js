...
function AllPatents() {
  ...
  var columns = [
    ...
    {
      title: "TITLE", field: "title", hidden: false, filterPlaceholder: 'HEC Patent', editable: 'never', cellStyle: {
        textAlign: 'left'
      }, width: 30,
    },
    {
  ...
  return (
    <div>
      <div><h3 className="mt-lg-4" style={{ color: '#262B40' }}>Patents Cases</h3>
        <p style={{ color: '#4a5073' }}>All the Patents related cases are in the below table and you can click on each case to view its details.</p></div>
