...
import { faAngleDown, faAngleUp, faChartArea, faChartBar, faChartLine, faFlagUsa, faFolderOpen, faClosedCaptioning, faGlobeEurope, faPaperclip, } from '@fortawesome/free-solid-svg-icons';
