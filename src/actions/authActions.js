...
// Archive User
export const archiveUser = id => dispatch => {
  var Id = localStorage.getItem("id")
  axios
    .get("http://18.116.70.71/api/Account/Archive", {
      params: {
        Id
      }
    })
...
export const updateUser = (userData, history) => dispatch => {
  ...
  axios
    .put("http://18.116.70.71/api/Account/Update?id=ab251b02-f377-4179-8a9d-adb1bf300685", userData)
